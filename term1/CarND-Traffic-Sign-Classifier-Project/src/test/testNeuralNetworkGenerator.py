...
class TestNeuralNetworkGenerator(unittest.TestCase):
    def test_number_of_permutations(self):
        ...
        generator = NeuralNetworkGenerator(n_classes=10, training_options_list=training_options_list,
                                           image_shape=[32, 32, 3])
        ...
        self.assertEqual(generator.get_n_trainings(),
                         expected_n_conv2d_permutations * expected_n_dense_permutations)
